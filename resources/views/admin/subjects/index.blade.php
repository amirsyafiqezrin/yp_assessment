                    ...
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left rtl:text-right text-black">
                            <thead class="text-xs text-black uppercase bg-gray-100">
                                <tr>
                                    <th scope="col" class="px-6 py-3 font-bold">Code</th>
                                    <th scope="col" class="px-6 py-3 font-bold">Name</th>
                                    <th scope="col" class="px-6 py-3 font-bold">Lecturer</th>
                            ...
                            <tbody>
                                @foreach($subjects as $subject)
                                    <tr class="bg-white border-b border-gray-200 hover:bg-gray-50 text-black">
                                        ...
                                        <td class="px-6 py-4">{{ $subject->lecturer->name }}</td>
                                        <td class="px-6 py-4 flex items-center space-x-3">
                                            <a href="{{ route('admin.subjects.edit', $subject) }}" title="Edit"
